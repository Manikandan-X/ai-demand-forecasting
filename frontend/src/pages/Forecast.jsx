      ...
      <div className="flex-1">
        ...
        <div className="p-6">
          ...
          <motion.div
            ...
            className="bg-white/80 backdrop-blur-lg p-6 rounded-3xl shadow-xl mb-6"
          >
            <div className="flex flex-col md:flex-row gap-4">
              <input
                type="number"
                placeholder="Enter Dataset ID"
                className="flex-1 border border-gray-300 rounded-2xl p-4 outline-none focus:ring-2 focus:ring-blue-400"
                value={datasetId}
                onChange={(e) => setDatasetId(e.target.value)}
              />
              <button
                onClick={handleForecast}
                className="bg-gradient-to-r from-blue-600 to-purple-700 text-white px-8 py-4 rounded-2xl shadow-lg hover:scale-105 transition"
              >
                Generate Forecast
              </button>
            </div>
          ...
          {modelComparison.length > 0 && (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
              ...
              <motion.div
                ...
                className="bg-white/80 backdrop-blur-lg rounded-3xl p-8 shadow-xl mb-10"
              >
                <h2 className="text-xl text-gray-500 font-semibold">
                  Forecast Accuracy (MAE)
                </h2>
                <p className="text-5xl font-black text-blue-700 mt-4">
                  {accuracy}
                </p>
              </motion.div>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 mb-10">
                ...
                <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-xl p-6">
                  <h2 className="text-2xl font-bold mb-6">Future Sales Trend</h2>
                  <div className="h-96">
                ...
                {/* BAR CHART */}
                <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-xl p-6">
                  <h2 className="text-2xl font-bold mb-6">Forecast Comparison</h2>
                  <div className="h-96">
                    <ResponsiveContainer width="100%" height="100%">
              ...
              {modelComparison.length > 0 && (
                ...
                <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-xl p-6 mb-10">
              ...
              {/* SUMMARY */}
              <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-xl p-6">
                <h2 className="text-2xl font-bold mb-5">Forecast Summary</h2>
